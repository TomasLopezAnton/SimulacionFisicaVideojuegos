...
public:
	...
	RBWindForceGenerator(const Vector3& v, double K1, double K2, Vector3 pos, double lb, double hb) : velocity(v), k1(K1), k2(K2), position(pos), lowerBound(lb), higherBound(hb) {};
