...
void FireworkSystem::createFireworkRules()
{
	...
	fireworkRules[1].set(1, 1, 2, { -20.0, 0.0, -20.0 }, { 20.0, 0.01, 20.0 }, 0.999, { {0, 4} });
	fireworkRules[2].set(2, 2, 3, { -30.0, 0.01, -30.0 }, { 30.0, 5.0, 30.0 }, 0.999, { {1, 5}, {0, 4} });
	fireworkRules[3].set(3, 2, 3, { -40.0, -5.0, -40.0 }, { 40.0, 30.0, 40.0 }, 0.999, { {2, 3}, {1,1}, {0,4} });
	fireworkRules[4].set(4, 0, 1, { -40.0, 30.0, 0.0 }, { -40.01, 30.01, 0.01 }, 0.999, { {2, 3}, {1,1}, {0,8}, {0, 3} });
	fireworkRules[5].set(5, 4, 5, { -10.0, 50.0, -10.0 }, { 10.0, 80.0, 10.0 }, 0.999, { {0, 4}, {1,2}, {2,2}, {3, 1}, {4, 2}});
	fireworkRules[6].set(6, 0.5, 1.5, { -10.0, -5.0, 0.0 }, { 20.0, 2.5, 0.01 }, 0.999, { {0, 4} });
