...
public:
	FoamSystem(DinamicRigidbody* b, Particle* w) : boat(b), water(w)
	{
		...
		Particle* foamParticle = new Particle({ 0, 0, 0 }, { 0, 0, 0 }, 0.05, 0.8, { 0, 0, 0 }, 5, { 0.7, 0.7, 0.7, 1.0 }, {0.4, 0.4, 0.4});
		
		foamGenerator = new GaussianParticleGenerator("foam", foamParticle, { 0, 0, 0 }, { 0, 0, 0 }, { 2, 0.001, 0.01 }, { 0.01, 0.001, 2.5 }, 10);
